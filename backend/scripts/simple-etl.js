...
async function simpleTest() {
  console.log('Starting simple ETL test...');
  ...
  if (fs.existsSync(sourceDocsPath)) {
    ...
    // Create sample requirements based on the files we found
    const requirements = [
      {
      ...
      },
      {
        ...
        "source_ref": "18-07-2022_4.2A.pdf"
      },
      {
    ...
    console.log('Requirements include source_ref pointing to source documents');
    
  } else {
    console.log('Source docs directory not found');
  }
}
